 ...
 */
void Focus_Display::setDisplayValue(unsigned long value, int decimalPointPosition)
{
 ...
 * be used to drive the 7 segment display.
 */
void Focus_Display::setDisplayValue2(unsigned long value, int decimalPointPosition)
{
  /* When updating the array that contains the display value interrupts are disabled.
   * This helps prevent display glitches.
   */
...
int Focus_Display::getRefreshRate()
{
  return REFRESHRATE;
}
